...
<p><strong>암시적 형변환 개념</strong></p> 
<p>'1'+1 = 문자+숫자 로 되어 결과는 2가 아닌 11로 나옴</p>
<p>데이터 타입은 문자(string)로 인식함</p>
<p>좌항 우황의 값을 비교하여 자동으로 데이터타입을 결정한 것</p>

<p><strong>명시적(암시적과 반대개념)</strong></p>
<p>직접 어떤 형으로 바꿀 지 명시해주는 것을 명시적 형변환이라고 함</p>
<p>var value="123.456";</p>
<p>Number(value); (여기서 N은 무조건 대문자, 주의하기)</p>
<p>(Number은 메소드임. 객체x)</p>

<p><strong>데이터 타입 확인 연산자 typeof</strong></p>


<p>1) 문자 => 숫자 변환(3가지이지만 자주쓰는것 한개만)</p>
<p>Number(대상)</p>

<p>2) 숫자 = > 문자 변환</p>
<p>String(대상)</p>

<p>**!!!변환전후로 console.log(typeof)로 확인해보기!!!</p>

<h3>연산자종류</h3>

<p><strong>산술연산자</strong></p>
<p>var a=10+20 //30</p>
<p>var b=50-20 //30</p>
<p>var c=5*1 //5</p>
<p>var d=6/3 //2</p>
...
<p><strong>연결연산자</strong></p>
<p>+나,로 표현하나 보통 +를 많이 사용함</p>
<p>"A" + "B" //AB //문자+문자</p>
<p>"A" + 10 //A10 //문자+숫자</p>
<p>"10" + 20 //1020 문자+숫자</p>

<p><strong>복합연산자</strong></p>
<p>(여기서 +는 기존의 값을 버리지 않고 이어서 진행하고 싶다는 기능)</p>
<p>var a = 10</p>
<p>a+=10 //20    //10+10=20</p>
<p>a*=10 //200  //20*10=200</p>
<p>a-=100 //100   //200-10</p>

<p><strong>증감연산자(++) 와 감소연산자(--)</strong></p>
<p>(무조건 1기준으로 숫자가 커짐,작아짐이 되는것)</p>
<p><strong>(**** ++의 위치가 앞이냐 뒤냐에 따라 값이 달라짐,
++가 뒤면 나중에 1추가 , ++위치가 앞이면 먼저+1한 값을 출력)</strong></p>


<h3>문자들 사이 안에서 숫자를 구별해주는 연결자</h3>
<p>let age = window.prompt('당신의 나이는?')</p>
<p>console.log('당신의 나이는 '+age+' 살입니다.')</p>
<p>여기서는 '문'+숫자(변수)+자'

<h3>템플릿 문자열</h3>
<p>console.log(`내후년 당신의 나이는 ${++age}살입니다`)</p>
